...
main(root_dir=root_dir, save_dir=save_dir, prepare_atlas_tissue=prepare_atlas_tissue, registration=registration, app_tran=app_tran, write_summary=write_summary, show=show)
